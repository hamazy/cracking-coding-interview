    ...
    (while (< i length)
      (let ((elem (aref screen i)))
        (let ((str (cci-format-in-binary elem)))
          ...
          (when (= (1- (/ width 8)) (mod i (/ width 8))) (setq result (concat result "\n")))))
      (setq i (1+ i)))
    result))
...
(cci-display-screen (cci-draw-horizontal-line [0 0 0 0 0 0 0 0] 16 0 3 1) 16)
;; "0000000000000000
;;  1111000000000000
;;  0000000000000000
;;  0000000000000000"

(cci-display-screen (cci-draw-horizontal-line [0 0 0 0 0 0 0 0] 16 0 15 2) 16)
;; "0000000000000000
;;  0000000000000000
;;  1111111111111111
;;  0000000000000000"
